...
public class NotificationServiceSecurityImpl implements NotificationService {
	    ...
	    public NotificationServiceSecurityImpl(EmailClient email) { 
	    	this.email = email; 
	    }
	    ...
	    public void metodoDeinterfazPropia(Order order) {
	        email.send(order.getCustomerEmail(),
	            "Pedido " + order.getId(),
	            "Gracias por su compra. Total: " + order.getTotal());
	    }
