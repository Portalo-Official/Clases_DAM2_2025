 ...
 */
public class ConsumidorStorage implements Runnable{
	
	private Storage_no_safe storage;
	private int index;
	...
	public ConsumidorStorage(Storage_no_safe storage, int index, int variacion) {
		super();
