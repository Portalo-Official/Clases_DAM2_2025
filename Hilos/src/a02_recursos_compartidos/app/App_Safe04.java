...
import a02_recursos_compartidos.hilo.ConsumidorStorage01;
import a02_recursos_compartidos.recurso_safe.Storage_safe;

public class App_Safe04 {

	
	public static void main(String[] args) {
		
		AtomicIntegerArray storageArray = new AtomicIntegerArray(new int[]{5, 4, 2, 7, 8, 3});
		Storage_safe storage= new Storage_safe(storageArray);
		
		ConsumidorStorage01 consumidor1 = new ConsumidorStorage01(storage, 0, -1000000);
		ConsumidorStorage01 consumidor2 = new ConsumidorStorage01(storage, 1, 1000000);
		ConsumidorStorage01 consumidor3 = new ConsumidorStorage01(storage, 0, 1000000);
